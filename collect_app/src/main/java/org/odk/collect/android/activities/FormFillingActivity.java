...
public class FormFillingActivity extends LocalizedActivity implements AnimationListener,
    ...
    private void loadFromIntent(Intent intent) {
        ...
        if (uriMimeType != null && uriMimeType.equals(InstancesContract.CONTENT_ITEM_TYPE)) {
            ...
            List<Form> candidateForms = getCandidateForms(instance.getFormId(), instance.getFormVersion());
            ...
            List<Form> candidateForms = getCandidateForms(entry.getFormId(), entry.getFormVersion());
            if (candidateForms.isEmpty()) {
    ...
    private List<Form> getCandidateForms(String formId, String version) {
        List<Form> candidateForms = formsRepository.getAllByFormIdAndVersion(formId, version);
        if (candidateForms.isEmpty()) {
            candidateForms = formsRepository.getAllByFormId(formId);
            if (candidateForms.isEmpty()) {
                candidateForms = formsRepository.getAllByFormId(formId.replace(" ", "_"));
                if (candidateForms.isEmpty()) {
                    candidateForms = formsRepository.getAllByFormId(formId.replace("_", " "));
                }
            }
