 ...
 */
public interface AdminUnitsTaskListener {

    void adminUnitsComplete(AdminUnitDetails adminUnitDetails, LoginSourceException exception);

    void progressUpdate(String currentFile, int progress, int total);

    void adminUnitsCancelled();
}
