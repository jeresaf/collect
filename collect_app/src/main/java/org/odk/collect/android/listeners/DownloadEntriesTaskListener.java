 ...
 */
public interface DownloadEntriesTaskListener {
    void entriesDownloadingComplete(Map<ServerEntryDetails, EntryDownloadException> result);

    void progressUpdate(String currentFile, int progress, int total);

    void entriesDownloadingCancelled();
}
